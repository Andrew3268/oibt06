...
class PromocodesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create promocode" do
    assert_difference('Promocode.count') do
      post promocodes_url, params: { promocode: { hastag: @promocode.hastag, title: @promocode.title } }
    end
  ...
  test "should update promocode" do
    patch promocode_url(@promocode), params: { promocode: { hastag: @promocode.hastag, title: @promocode.title } }
